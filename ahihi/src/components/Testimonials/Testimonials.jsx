          ...
          <div className="container page-padding">
            ...
            <div className="border-[#efefef] mt-[17rem] md1000:mt-[9rem] bg-white border-solid border-[9px] p-[30px] min540:h-[48rem] min375:h-[60rem]">
              <div className="bg-black overflow-x-clip w-full h-[33rem] relative">
                ...
                <img
                    alt="girl_img"
                    src={'https://scontent.fsgn2-9.fna.fbcdn.net/v/t1.15752-9/299459905_1844121885931602_8747002333229682345_n.jpg?_nc_cat=103&ccb=1-7&_nc_sid=ae9488&_nc_ohc=G-tziCp0WCcAX_6uA0g&_nc_ht=scontent.fsgn2-9.fna&oh=03_AdSDvzdmDnXA9YaHbaKfvWbRMQk_C1nAz0LkmbWVgifvnQ&oe=64D72C51'}
