          ...
          >
            ...
            <div className="mt-[10.5rem] relative md1000:items-center md1000:flex md1000:flex-col md1000:text-center md1000:w-[full]">
              ...
              <h2 className="text-[35px] font-bold leading-tight mb-6 w-[60rem] min800:w-[100%]">
                Đưa sức khỏe và cơ thể của bạn lên một tầm cao mới
              </h2>
              <p className="text-[16px] text-[#646464] font-medium ">
                Đưa sức khỏe và cơ thể của bạn lên một tầm cao mới với
                chương trình toàn diện được thiết kế để giúp bạn đạt được sức khỏe của bạn
                bàn thắng.
              </p>
              {/* about text icons */}
