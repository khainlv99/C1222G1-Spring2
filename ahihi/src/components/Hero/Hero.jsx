    ...
    <>
      ...
      >
        <div className="container-hero">
          ...
          >
            <p className="text-black text-[16px] uppercase font-medium relative z-10 pl-16 min800:pl-0 mb-8" style={{paddingLeft: "7rem"}}>
             Tìm năng lượng
            </p>
            <img
              src={TitleBg}
            ...
            <h1 className="font-bold text-[48px] uppercase mb-[4rem] min450:text-[40px]">
              Làm cho cơ thể <br />
              <span className="font-thin">phù hợp & hoàn hảo</span>
            </h1>

            <MainButton
              color={`text-black`}
              bg={`bg-white`}
              text="Lớp của chúng tôi"
              goTo="/classes"
            />
          </div>
        </div>
        ...
        >
          <p className="uppercase  text-3xl font-bold tracking-widest">Chia sẻ</p>
